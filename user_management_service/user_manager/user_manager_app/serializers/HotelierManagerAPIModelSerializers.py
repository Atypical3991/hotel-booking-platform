...
class CreateHotelierSerializer(serializers.Serializer):
    ...
    business_name = serializers.CharField(max_length=256, required=True)

    def create(self, validated_data):
        Hotelier.objects.create(**validated_data)
...
class UpdateHotelierSerializer(serializers.Serializer):
